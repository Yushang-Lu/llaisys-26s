"""ctypes declarations for the native Qwen2 model API."""
...
class LlaisysQwen2Meta(Structure):
    """ABI-compatible copy of ``struct LlaisysQwen2Meta``."""
...
class LlaisysQwen2Weights(Structure):
    """Borrowed tensor handles owned by a ``LlaisysQwen2Model`` instance."""
...
# ``struct LlaisysQwen2Model`` is deliberately opaque to Python.
