...
void launchAdd(
    ...
    addKernel<<<elementwiseBlocks(numel, threads), threads, 0, stream>>>(
        ...
        numel);
    device::metax::checkKernelLaunch("add kernel launch");
}
...
void add(
    ...
    case LLAISYS_DTYPE_F32:
        return launchAdd<float>(c, a, b, numel, macaStream(stream));
    case LLAISYS_DTYPE_F16:
        return launchAdd<__half>(c, a, b, numel, macaStream(stream));
    case LLAISYS_DTYPE_BF16:
        return launchAdd<__nv_bfloat16>(c, a, b, numel, macaStream(stream));
    default:
